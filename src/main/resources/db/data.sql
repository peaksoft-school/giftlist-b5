...
VALUES (1, 'admin@gmail.com', 'Admin', true, 'string','$2a$12$xEFzerKnyLVgXyBQ/ecOjuVs5rDd2KgixXHHvPSIqTN7TDnRH0Oba', 'photo', 'ADMIN', 1),
       (2, 'user@gmail.com', 'USER', true, 'string','$2a$12$YVsqnm/x/Z4xxsqzdPIAWeq3TNLZx/KEmMvAMQ4i8obMHd9YkxhYW','photo', 'USER', 2);
