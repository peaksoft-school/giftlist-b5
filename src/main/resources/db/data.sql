...
values (1, 'California', 'XXL', '2004-12-12', 'facebook.com', 'playing pubg', 'I love eat', 'instagram.com','0777 345 342', 'photo', 34, 'telegram.com', 'vk.com'),
       (2, 'Texas', 'XL', '1999-05-15', 'facebook.com', 'music', 'I love soccer', 'instagram.com', '0777 345 879','photo', 42, 'telegram.com', 'vk.com');

insert into users(id, email, first_name, friend_status, is_block, last_name, password, role, user_info_id)
VALUES (1, 'admin@gmail.com', 'Admin', 'NOT_FRIEND',false, 'string','$2a$12$xEFzerKnyLVgXyBQ/ecOjuVs5rDd2KgixXHHvPSIqTN7TDnRH0Oba', 'ADMIN', 1),
       (2, 'user@gmail.com', 'USER', 'NOT_FRIEND', false, 'string','$2a$12$YVsqnm/x/Z4xxsqzdPIAWeq3TNLZx/KEmMvAMQ4i8obMHd9YkxhYW', 'USER', 2);
